	...
	<div class="container">
		<div class="row centered mt mb">
			...
			<span style="font-family:Microsoft JhengHei;color:#FFFFFF;">
				<h2>員工管理</h2>
				<div class="col-lg-6 col-md-6 col-sm-6 gallery" style="text-align:center;"><a href="create_mem.php"><button class="btn btn-default" type="submit" style="width:200px;height:90px;font-size:35px;">新增員工</button></a></div>
				<div class="col-lg-6 col-md-6 col-sm-6 gallery" style="text-align:center;"><a href="modify_mem.php"><button class="btn btn-default" type="submit" style="width:200px;height:90px;font-size:35px;">員工資料</button></a></div>
			</span>
			</div>
