	...
	<div class="container">
		<div class="row centered mt mb">
			...
			<span style="font-family:Microsoft JhengHei;color:#000000;">
				<h2>物品管理</h2>
				<div class="col-lg-6 col-md-6 col-sm-6 gallery" style="text-align:center;">
				<a href="create_Obj.php"><button class="btn btn-default" type="submit" style="width:250px;height:90px;font-size:40px;">新增物品</button></a>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 gallery" style="text-align:center;">
				<a href="modify_obj.php"><button class="btn btn-default" type="submit" style="width:250px;height:90px;font-size:40px;">查詢修改</button></a>
				</div>
			</span>
			</div>
