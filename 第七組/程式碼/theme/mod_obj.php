...
<html lang="en">
 ...
 <?php
		if(isset($_POST["send"])){
			...
			$result=mysqli_query($link,"UPDATE `ITEM` SET `i_name`='$name',`i_total`='$total',`i_reserve`='$res',`i_others`='$others',`i_remark`='$remark' WHERE i_id='$ID'");
