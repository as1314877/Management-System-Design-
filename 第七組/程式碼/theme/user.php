	...
	<div class="container">
		...
		<span style="font-family:Microsoft JhengHei;color:#FFFFFF;">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 gallery" style="text-align:center;">
				<a href="applyLogin.php"><button class="btn btn-default" type="submit" style="width:250px;height:90px;font-size:40px;">已申請</button></a>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-3 gallery" style="text-align:center;">
				<a href="nonApply.php"><button class="btn btn-default" type="submit" style="width:250px;height:90px;font-size:40px;">未申請</button></a>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-3 gallery" style="text-align:center;"></div>
			</span>
		</div><! --/row -->
